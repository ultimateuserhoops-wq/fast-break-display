...
import {
  type HotAction, HOTKEY_DEFAULTS, HOTKEY_LABELS, HOTKEY_ACTIONS, HOTKEY_GROUPS,
  loadHotkeys, saveHotkeys, keyLabel, keyMatches, loadSplitClock, saveSplitClock, useScoreboardHotkeys,
} from "@/lib/hotkeys";
